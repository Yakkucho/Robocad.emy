...
class HeroSplit extends React.Component {
  ...
  render() {
    ...
    const {
      ...
      alignTop,
      imageFill,
      // 1. Terima props onPricingClick yang dikirim dari Home.js
      onPricingClick,
      onFeaturesClick,
      ...props
    } = this.props;
              ...
              <div className="split-item">
                <div className="hero-content split-item-content center-content-mobile reveal-from-top">
                  ...
                  <p className="mt-0 mb-32">
                    Akademi Robotika terbaik di Indonesia dengan standar internasional.
                  </p>
                  <ButtonGroup>
                    {/* 2. Ubah tombol ini */}
                    <Button color="primary" wideMobile onClick={onPricingClick}>
                      Harga
                    </Button>
                    <Button color="dark" wideMobile onClick={onFeaturesClick}>
                ...
                <div className="hero-figure split-item-image split-item-image-fill illustration-element-01 reveal-from-bottom">
                  ...
                  >
                    <Image
                      src={require('./../../assets/images/pexels-cottonbro-4861395.jpg')}
                      alt="Hero"
                      width={528}
                      height={396} />
                  </a>
