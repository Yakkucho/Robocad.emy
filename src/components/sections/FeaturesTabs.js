...
class FeaturesTabs extends React.Component {
  ...
  render() {
    ...
    const sectionHeader = {
      title: 'Galeri',
      paragraph: 'Lihat lebih dekat bagaimana proses belajar, berkarya, dan berkolaborasi di dalam ekosistem Robocad.'
    };
            ...
            <Tabs active="tab-a">
              ...
              <TabPanel id="tab-a">
                <Image
                  ...
                  src={require('./../../assets/images/fasilitas2.png')}
              ...
              <TabPanel id="tab-b">
                <Image
                  className="has-shadow"
                  src={require('./../../assets/images/proyek.png')}
              ...
              <TabPanel id="tab-c">
                <Image
                  className="has-shadow"
                  src={require('./../../assets/images/kegiatan2.png')}
