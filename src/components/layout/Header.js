...
class Header extends React.Component {
  ...
  render() {
    const {
      ...
      bottomOuterDivider,
      bottomDivider,
      location, // Get location from props
      ...props
    } = this.props;
    ...
    // Check if we are on the About page (Secondary)
    const isAboutPage = location.pathname.includes('/Secondary');
                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                    <ul className={
                      ...
                      {isAboutPage && (
                        <li>
                          <Link to="/" onClick={this.closeMenu}>Beranda</Link>
                        </li>
                      )}
                      <li>
                        <Link to="/Secondary/" onClick={this.closeMenu}>Tentang</Link>
                      </li>
                    </ul>
                    {!hideSignin &&
                      <ul
                      ...
                      >
                        <li>
                          <Link to="/signup/" className="button button-primary button-wide-mobile button-sm" onClick={this.closeMenu}>Daftar</Link>
                        </li>
                      </ul>}
                  </div>
                </nav>
